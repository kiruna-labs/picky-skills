...
description: |
  ...
  Coordinates picky-security, picky-design, picky-tester, picky-performance, and picky-landingpage in optimal sequence.
...
| Landing page / marketing site | landingpage, design, performance, security |
...
2. **Second Wave (After security completes):**
   ...
   - `picky-landingpage` - Needs running application (for landing pages/marketing sites)
...
# Landing Page Audit (for marketing/landing pages, requires running app)
"Invoke picky-landingpage agent to audit the landing page at [URL]"
```
...
- Conversion weakness → affects landingpage and design findings
- Slow page load → affects performance and landingpage conversion

**Priority Matrix:**

| Security Severity | Design Severity | Performance Impact | Landing Page | Combined Priority |
|-------------------|-----------------|-------------------|--------------|-------------------|
| Critical | Any | Any | Any | P0 - Immediate |
| High | Critical | > 1s | Critical | P0 - Immediate |
| High | Major | 200ms-1s | High | P1 - This Sprint |
| Medium | Major | 50-200ms | Medium | P2 - Next Sprint |
| Low | Minor | < 50ms | Low | P3 - Backlog |
...
[Summary from picky-landingpage — include if landing page/marketing site was audited]
...
- Run all: security + design + performance + tester + landingpage (if applicable)
