...
description: Ultra-thorough performance audit with Core Web Vitals focus. Analyzes bundle size, code splitting, images, fonts, caching, API patterns, runtime performance, and N+1 queries. Produces scored reports with exact measurements and fixes. Trigger with "performance audit", "why is this slow", "Core Web Vitals", "bundle size", "picky performance".
---
