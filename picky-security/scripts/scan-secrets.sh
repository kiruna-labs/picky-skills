...
echo "Checking for GitHub fine-grained tokens..."
scan_pattern "github_pat_[a-zA-Z0-9_]\{20,\}" "GitHub fine-grained personal access token" "CRITICAL"

# Vercel tokens
echo "Checking for Vercel tokens..."
scan_pattern "vercel_[a-zA-Z0-9_]\{20,\}" "Vercel token" "CRITICAL"

# Supabase keys
echo "Checking for Supabase keys..."
scan_pattern "sbp_[a-zA-Z0-9]\{20,\}" "Supabase key" "CRITICAL"

# Planetscale tokens
echo "Checking for Planetscale tokens..."
scan_pattern "pscale_tkn_[a-zA-Z0-9_]\{20,\}" "Planetscale token" "CRITICAL"

# Clerk keys
echo "Checking for Clerk keys..."
scan_pattern "sk_live_[a-zA-Z0-9]\{20,\}" "Clerk/Stripe live secret key" "CRITICAL"
scan_pattern "pk_live_[a-zA-Z0-9]\{20,\}" "Clerk/Stripe live publishable key" "CRITICAL"
scan_pattern "sk_test_[a-zA-Z0-9]\{20,\}" "Clerk/Stripe test secret key" "CRITICAL"
scan_pattern "pk_test_[a-zA-Z0-9]\{20,\}" "Clerk/Stripe test publishable key" "CRITICAL"

# Neon API keys
echo "Checking for Neon keys..."
scan_pattern "neon_[a-zA-Z0-9_]\{20,\}" "Neon API key" "CRITICAL"

# Resend keys
echo "Checking for Resend keys..."
scan_pattern "re_[a-zA-Z0-9_]\{20,\}" "Resend key" "CRITICAL"

# OpenAI keys
echo "Checking for OpenAI keys..."
scan_pattern "sk-proj-[a-zA-Z0-9]\{20,\}" "OpenAI project key" "CRITICAL"

# Anthropic keys
echo "Checking for Anthropic keys..."
scan_pattern "sk-ant-[a-zA-Z0-9]\{20,\}" "Anthropic API key" "CRITICAL"

# Linear API keys
echo "Checking for Linear keys..."
scan_pattern "lin_api_[a-zA-Z0-9]\{20,\}" "Linear API key" "CRITICAL"
